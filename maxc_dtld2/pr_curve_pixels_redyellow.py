...
for file in list_dir_all:
    ...
    if 'Yellow.txt' in file:
        yellow.append(file)
    if 'Red-yellow.txt' in file:
        red_yellow.append(file)
...
for file_b5 in list_dir_all_b5:
    ...
    if 'Red-yellow.txt' in file_b5:
        red_yellow_b5.append(file_b5)
...
for file_b10 in list_dir_all_b10:
    ...
    if 'Red-yellow.txt' in file_b10:
        red_yellow_b10.append(file_b10)
...
precision_red_yellow = np.loadtxt(prefix+red_yellow[0])
recall_red_yellow = np.loadtxt(prefix+red_yellow[1])
...
precision_red_yellow_b5 = np.loadtxt(prefix5+red_yellow_b5[0])
recall_red_yellow_b5 = np.loadtxt(prefix5+red_yellow_b5[1])
...
precision_red_yellow_b10 = np.loadtxt(prefix10+red_yellow_b10[0])
recall_red_yellow_b10 = np.loadtxt(prefix10+red_yellow_b10[1])
print ('All loaded')
...
plt.step(recall_red_yellow,precision_red_yellow,label='all')
plt.step(recall_red_yellow_b5,precision_red_yellow_b5,label='width > 5')
plt.step(recall_red_yellow_b10,precision_red_yellow_b10,label='width > 10')
plt.xlabel('Recall')
plt.ylabel('Precision')
plt.legend(loc='lower left')
...
fig4.savefig(model_name+'_pixels_prcurve_RY',dpi=300)
print ('Saved')