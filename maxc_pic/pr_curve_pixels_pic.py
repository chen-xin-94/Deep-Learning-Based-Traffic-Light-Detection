...
for file_b5 in list_dir_all_b5:
    ...
    if 'Green_Circle.txt' in file_b5:
        Green_Circle_b5.append(file_b5)
        
for file_b10 in list_dir_all_b10:
    if 'Red_Circle.txt' in file_b10:
        Red_Circle_b10.append(file_b10)
    if 'Green_Circle.txt' in file_b10:
        Green_Circle_b10.append(file_b10)
...
precision_Green_Circle_b5 = np.loadtxt(prefix5+Green_Circle_b5[0])
recall_Green_Circle_b5 = np.loadtxt(prefix5+Green_Circle_b5[1])
...
precision_Green_Circle_b10 = np.loadtxt(prefix10+Green_Circle_b10[0])
recall_Green_Circle_b10 = np.loadtxt(prefix10+Green_Circle_b10[1])
...
plt.step(recall_Green_Circle,precision_Green_Circle,label='all')
plt.step(recall_Green_Circle_b5,precision_Green_Circle_b5,label='width > 5')
plt.step(recall_Green_Circle_b10,precision_Green_Circle_b10,label='width > 10')
...
fig2.savefig(model_name+'_pixels_prcurve_GC',dpi=300)
print ('Saved')